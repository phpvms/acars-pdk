...
*/
    function ViolatedAfterDelay(id: string, timeout: number, callback: () => RuleValue) : RuleValue
{
...
* @param percent 
*/
    function NumberWithinPercent(value: number, level: number, percent: number) : boolean
{
...
* @param percent 
*/
    function NumberOverPercent(value: number, level: number, percent: number) : boolean
{
